...
imagesLoaded(images, startTimeline);



function startTimeline()
{
    console.log("artwork images have been loaded");

    //loop through each images and create gsap timeline for each of them
    images.forEach(element =>
    {
        element = new ImageHover(element);  
    });
}
...
class ImageHover 
{
    ...
    constructor(DOM_el) {
        ...
        // Get bg image url
        this.bgImage ="url('images/"+this.DOM.el.style.backgroundImage.substring(12, (this.DOM.el.style.backgroundImage.length));
        ...
        this.totalInnerElems = +this.DOM.el.dataset.repetitionElems || 6;
        ...
        for (let i = 0, len = this.totalInnerElems || 1; i <= len - 1; ++i) {
            innerHTML += i === 0 ? 
                ...
                <div class="image__element" style="background-image:${this.bgImage};"></div></div>` :
                `<div class="image__element" style="background-image:${this.bgImage};"></div>`    
        }
