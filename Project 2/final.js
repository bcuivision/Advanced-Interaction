...
let decision = document.getElementById("decisions");
...
//   decision.style.height = "100vh";

  button.style.width = "3000px";
  button.style.height = "3000px";
  button.style.margin = "0";
  button.style.zIndex = "9999";

//   decision.style.left = "-50%";
//   decision.style.top = "-20%";
